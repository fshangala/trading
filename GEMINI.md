...
- **Environment:** Always use the virtual environment's Python interpreter: `.\env\Scripts\python.exe`.
- **API Access:** Use the `.env` file for `BINANCE_API_KEY` and `BINANCE_API_SECRET`.
